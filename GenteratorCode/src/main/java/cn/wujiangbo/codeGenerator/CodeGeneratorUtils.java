package cn.wujiangbo.codeGenerator;
...
public class CodeGeneratorUtils {
     ...
     * 修改成自己的配置文件名称即可
     */
    static ResourceBundle rb = ResourceBundle.getBundle("MyBatisPlus-config-tangrufei-order"); //不要加后缀.properties

    //代码存储的项目根目录
    private static String baseProjectPath = rb.getString("baseProjectPath");
    //存放：controller、service、mapper、mapper.xml、domain、query的模块目录
    private static final String projectServerPath = baseProjectPath + "OrderService-8004";
    //存放：vue页面和js文件路径
    private static final String projectWebsitePath =  "UI";
    //作者名称
