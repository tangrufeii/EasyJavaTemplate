  ...
  <div class="app-container">
    ...
    <el-table :height="tableMaxHeight" stripe border v-loading="loading" :data="tableDataList"
      ...
      <el-table-column type="selection" width="55" align="center"/>
          ...
          <el-table-column prop="userName" :show-overflow-tooltip="true" width="150" label="员工姓名">
          </el-table-column>

          <el-table-column prop="email" :show-overflow-tooltip="true" width="150" label="用户邮箱">
          </el-table-column>

          <el-table-column prop="phone" :show-overflow-tooltip="true" width="150" label="手机号码">
          </el-table-column>

          <el-table-column prop="remark" :show-overflow-tooltip="true" width="150" label="备注">
          </el-table-column>

          <el-table-column prop="age" :show-overflow-tooltip="true" width="150" label="年龄">
          </el-table-column>
      ...
      <div style="width: 80%;margin-left: 50px;">
        <el-form ref="addFormRef" :model="addForm" :rules="rules" label-width="120px">
              ...
              <el-form-item label="员工姓名" prop="userName">
                <el-input v-model="addForm.userName" placeholder="员工姓名" auto-complete="off" maxlength="50" show-word-limit style="width: 100%;"></el-input>
              </el-form-item>

              <el-form-item label="用户邮箱" prop="email">
                <el-input v-model="addForm.email" placeholder="用户邮箱" auto-complete="off" maxlength="50" show-word-limit style="width: 100%;"></el-input>
              </el-form-item>

              <el-form-item label="手机号码" prop="phone">
                <el-input v-model="addForm.phone" placeholder="手机号码" auto-complete="off" maxlength="50" show-word-limit style="width: 100%;"></el-input>
              </el-form-item>

              <el-form-item label="备注" prop="remark">
                <el-input v-model="addForm.remark" placeholder="备注" auto-complete="off" maxlength="50" show-word-limit style="width: 100%;"></el-input>
              </el-form-item>

              <el-form-item label="年龄" prop="age">
                <el-input v-model="addForm.age" placeholder="年龄" auto-complete="off" maxlength="50" show-word-limit style="width: 100%;"></el-input>
              </el-form-item>
